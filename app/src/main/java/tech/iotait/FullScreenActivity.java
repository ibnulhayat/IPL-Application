...
public class FullScreenActivity extends AppCompatActivity implements OnPreparedListener, View.OnClickListener {
    private static final int SYSTEM_ALERT_WINDOW_PERMISSION = 2084;
    private VideoView videoView;
    private ImageView potratitButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutLoading = findViewById(R.id.img_loading);
        largeBannerAdsLode();
        ...
        videoView.setOnPreparedListener(FullScreenActivity.this);
        videoView.setRepeatMode(Player.REPEAT_MODE_ONE);
        videoView.setVideoRotation(0);


        potratitButton = findViewById(R.id.potratitButton);
        ...
        potratitButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent landIntent = new Intent(FullScreenActivity.this, LiveCricketVideoActivity.class);
                landIntent.putExtra("url", Videourl);
    ...
    private void largeBannerAdsLode() {
        mRequestQueue = Volley.newRequestQueue(FullScreenActivity.this);
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        JSONObject object1 = fixobject.getJSONObject("largebanner");
                        ...
                        if (action.equals("0")) {
                            ...
                            mFbAddView = new AdView(FullScreenActivity.this, Ads.fb_banner, AdSize.BANNER_HEIGHT_50);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(this)) {
            ...
            if (TextUtils.isEmpty(small_url)) {
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                    Intent intent = new Intent(FullScreenActivity.this, FloatingViewService.class);
    ...
    private void backPress() {
        Intent intent1 = new Intent(FullScreenActivity.this, LiveCricketVideoActivity.class);
